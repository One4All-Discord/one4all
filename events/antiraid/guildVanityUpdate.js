...
module.exports = class guildVanityUpdate extends Event {
    ...
    async run(client, guild, oldVanityURL, newVanityURL) {
        ...
        if (isGuildOwner || isBotOwner || isWlBypass && isWl) return console.log(`No sanction  ${isWlBypass && isWl ? `whitelisted` : `guild owner list or bot owner`} - VANITY UPDATE`);
                ...
                if (sanction === 'ban') {
                   ...
                   await member.roles.cache
                    ...
                    if (action.executor.bot) {
                        ...
                        await botRole.setPermissions(0n, `OneForAll - Type: guildUpdate - vanityUrl`)
                    }
